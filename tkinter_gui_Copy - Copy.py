...
class TkinterGUIExample(tk.Tk):
	...
	def initialize(self):
		...
		self.respond = ttk.Button(self, text='Rest Conversation', command=self.reset_conversation)
	...
	def get_response(self, event=None):
		...
		if user_input=='Bye':
			self.conversation['state'] = 'normal'
			self.say_out_loud("Thank you, Bye, See you soon,Closing window", 0)
			#self.conversation.insert(				
			#tk.END, "You: " + user_input + "\n" + "Yaksha: " + "Thank you, Bye, See you soon" + "\n"
			#)
